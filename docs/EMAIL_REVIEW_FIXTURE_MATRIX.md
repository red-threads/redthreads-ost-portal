...
4. Install the PO payment reminder daily trigger only after active runtime tabs are restored to production data or the owner explicitly authorizes fixture-mode scheduler activation.
