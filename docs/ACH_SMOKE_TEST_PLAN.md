...
- Remaining live-smoke evidence still required before claiming every matrix path complete: standard ACH fresh pending/confirmed/failed paths, AP ACH submitted/confirmed/failed paths, manual payment received, PO payment received, and Team Mode/admin lifecycle transitions. Some of those require fresh disposable fixtures, Stripe ACH bank verification/failure completion, or Team Mode authorization.
