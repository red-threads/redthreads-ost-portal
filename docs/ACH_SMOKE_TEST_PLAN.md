...
Do not build a Red Threads portal form for microdeposit amounts. For internal Stripe test-mode fallback when the hosted verification URL is unavailable, verify through Stripe tooling/API only:
