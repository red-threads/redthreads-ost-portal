...
- Remaining live-smoke evidence still required before claiming every matrix path complete: AP ACH failed/action-needed, manual payment received, PO payment received, and Team Mode/admin lifecycle transitions. Some of those require a fresh AP disposable fixture, Stripe ACH failure completion, or Team Mode authorization.
