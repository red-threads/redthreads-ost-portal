...
- Stable Apps Script deployment `AKfycbz9qDgp65f5S3RWhSxGftioMXKKU9O1N0mpHh3waoKY2YyvE72F-cJk-0XYr5YXg4bw` is currently version `847`, `Complete ACH saved-bank and verification UX`.
...
- Existing stable deployment ID is present: `AKfycbz9qDgp65f5S3RWhSxGftioMXKKU9O1N0mpHh3waoKY2YyvE72F-cJk-0XYr5YXg4bw`, currently deployed at version 847, `Complete ACH saved-bank and verification UX`.
...
- ACH V1 infrastructure was deployed to the stable Apps Script deployment as version 844, hardened and redeployed as versions 845 and 846 on 2026-06-01, then completed as version 847 to strengthen saved-bank redisplay/defaulting and verification/cancel UX.
