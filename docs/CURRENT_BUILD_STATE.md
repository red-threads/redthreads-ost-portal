...
- Existing stable deployment ID is present: `AKfycbz9qDgp65f5S3RWhSxGftioMXKKU9O1N0mpHh3waoKY2YyvE72F-cJk-0XYr5YXg4bw`, currently deployed at version 839, `Clean mobile portal link display`.
...
- Public stable URL smoke test confirmed the deployed HTML contains `Development revision 14`, `portalMobileBlock`, `RT_PORTAL_MOBILE_BLOCK_QUERY`, and the updated mobile copy-link fallback. Stale `Development revision 13` is absent.
